    ...
    <div class="flex-1 flex flex-col min-w-0">
      <main class="flex-1 p-4 md:p-6 overflow-hidden">
        ...
        <div
          ...
          class="bg-white rounded-lg shadow overflow-x-auto scrollbar-hide"
        >
          <div
            class="flex bg-gray-200 text-gray-700 font-semibold p-3 text-[11px] md:text-sm uppercase tracking-wider min-w-[550px]"
          >
            <div class="flex-1 pl-4">Tên Danh mục</div>
            <div class="w-1/4 text-center">Số lượng sản phẩm</div>
